...
PEER0_ORG1_CA=/opt/gopath/src/github.com/hyperledger/udo/peer/crypto/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt
PEER0_ORG2_CA=/opt/gopath/src/github.com/hyperledger/udo/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
...
setGlobals () {
	...
	if [ $ORG -eq 1 ] ; then
		...
		CORE_PEER_ADDRESS=peer0.org1.example.com:7051
		CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/udo/peer/crypto/idemix/idemix-config
...
checkOSNAvailability() {
	...
	CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/udo/peer/crypto/ordererOrganizations/example.com/orderers/orderer.example.com/msp
...
installChaincode () {
	...
	ORG=$2
	setGlobals $PEER $ORG
	peer chaincode install -n mycc -v 1.0 -p github.com/hyperledger/udo/examples/chaincode/go/example02/cmd >&log.txt
	res=$?
	cat log.txt
