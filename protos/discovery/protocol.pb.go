...
package discovery // import "github.com/hyperledger/udo/protos/discovery"

import proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import gossip "github.com/hyperledger/udo/protos/gossip"
import msp "github.com/hyperledger/udo/protos/msp"
...
type ConfigResult struct {
	// msps is a map from MSP_ID to UdoMSPConfig
	Msps map[string]*msp.UdoMSPConfig `protobuf:"bytes,1,rep,name=msps" json:"msps,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (m *ConfigResult) GetMsps() map[string]*msp.UdoMSPConfig {
	if m != nil {
		return m.Msps
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*msp.UdoMSPConfig)(nil), "discovery.ConfigResult.MspsEntry")
