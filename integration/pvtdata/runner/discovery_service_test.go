...
var _ bool = Describe("DiscoveryService", func() {
	...
	AfterEach(func() {
		...
		filters = map[string][]string{}
		filters["label"] = []string{"org.hyperledger.udo.chaincode.id.name=mytest"}
	...
	It("test discovery service capabilities", func() {
		...
		installCC.InstallChaincode("mytest", "1.0", "github.com/hyperledger/udo/integration/chaincode/simple/cmd")
