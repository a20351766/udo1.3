...
import (
	...
	pvtdatarunner "github.com/hyperledger/udo/integration/pvtdata/runner"
...
func (c *Components) Build(args ...string) {
	...
	discoveryService, err := gexec.Build("github.com/hyperledger/udo/cmd/discover", args...)
	Expect(err).NotTo(HaveOccurred())
