...
# same for Vagrant.
# See https://github.com/hyperledger/udo/blob/master/docs/dev-setup/install.md
#
# To get started:
#       sudo su
#       yum install git
...
if [ -n -d $HOME/git/src/github.com/hyperledger/udo ]
then
    echo "Script udo code is under $HOME/git/src/github.com/hyperledger/udo "
    exit
fi
