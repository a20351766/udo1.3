...
#
# See https://github.com/hyperledger/udo/blob/master/docs/dev-setup/install.md#building-outside-of-vagrant-
#
...
#	sudo ./udo/devenv/setupUbuntuOnPPC64el.sh
...
if [ ! -d "$GOPATH/src/github.com/hyperledger/udo" ]
then
    echo "Ensure udo code is under $GOPATH/src/github.com/hyperledger/udo"
    exit
fi
