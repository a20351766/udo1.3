...
import (
	...
	"github.com/hyperledger/udo/core/ledger/kvledger/txmgmt/statedb/commontests"
...
func TestMain(m *testing.M) {
	viper.Set("peer.fileSystemPath", "/tmp/udo/ledgertests/kvledger/txmgmt/statedb/stateleveldb")
	os.Exit(m.Run())
}
