...
`this java SDK example <https://github.com/hyperledger/udo-sdk-java/blob/release-1.3/src/test/fixture/sdkintegration/gocc/sample1/src/github.com/example_cc/example_cc.go>`_.
