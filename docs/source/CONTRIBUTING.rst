...
email to the hyperledger-udo@lists.hyperledger.org mailing list linking the
...
Getting the support of three or more of the Hyperledger Udo maintainers for the new
