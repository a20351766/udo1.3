...
``transient`` field by calling the ```GetTransient()`` API <https://github.com/hyperledger/udo/blob/13447bf5ead693f07285ce63a1903c5d0d25f096/core/chaincode/shim/interfaces_stable.go>`_.
...
* Note that private data collections only define which organization’s peers
  ...
  using the client identity `chaincode library <https://github.com/hyperledger/udo/tree/master/core/chaincode/lib/cid>`__ .
