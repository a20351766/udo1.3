...
* :doc:`chaincode4ade`:
  As an addition to the current Udo support for chaincode written in Go and
  node.js, Java is now supported. You can find a javadoc for this
  `here <https://udo-chaincode-java.github.io/>`__.
...
* `Udo release notes <https://github.com/hyperledger/udo/releases/tag/v1.3.0-rc1>`_.
* `Udo CA release notes <https://github.com/hyperledger/fabric-ca/releases/tag/v1.3.0-rc1>`_.
