...
func TestMetricsByStatsdReporter(t *testing.T) {
	...
	expected := []string{
		`hyperledger_udo.peer.success_total.component-committer.env-test:1|c`,
		`hyperledger_udo.peer.channel_total.component-committer.env-test:4|g`,
	}
...
func TestMetricsByPrometheusReporter(t *testing.T) {
	...
	expected := []string{
		`# HELP hyperledger_udo_peer_channel_total hyperledger_udo_peer_channel_total gauge`,
		`# TYPE hyperledger_udo_peer_channel_total gauge`,
		`hyperledger_udo_peer_channel_total{component="committer",env="test"} 4`,
		`# HELP hyperledger_udo_peer_success_total hyperledger_udo_peer_success_total counter`,
		`# TYPE hyperledger_udo_peer_success_total counter`,
		`hyperledger_udo_peer_success_total{component="committer",env="test"} 1`,
		``,
	}
